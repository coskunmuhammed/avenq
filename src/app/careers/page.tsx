...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: 'Careers — AVENQ',
    description: 'Engineering culture, code review practices, and profile submission at AVENQ.',
    url: 'https://avenq.pro/careers',
  },
};
...
export default function CareersPage() {
  ...
  return (
    <>
      ...
      />
      <div className="w-full flex flex-col gap-12 sm:gap-16 md:gap-36 pb-24 pt-4 md:pt-16">
        {/* Header */}
        <section>
        ...
        <section>
          <Container size="normal" className="flex flex-col gap-8 md:gap-10">
            <div className="flex flex-col gap-2 border-b border-[var(--border-subtle)] pb-4 md:pb-6">
              ...
              <Typography variant="h2" className="text-2xl sm:text-3xl md:text-4xl">How We Work</Typography>
            </div>
